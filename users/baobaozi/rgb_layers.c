...
// const rgblight_segment_t PROGMEM fangbian_layer[] = RGBLIGHT_LAYER_SEGMENTS(
//     {0, RGBLED_NUM/4, HSV_GOLD}, // between magenta and pink
//     {RGBLED_NUM/4, (RGBLED_NUM/4)*3, HSV_RED},
//     // {RGBLED_NUM/2, RGBLED_NUM, HSV_WHITE},
//     {(RGBLED_NUM/4)*3, RGBLED_NUM, HSV_GOLD} // between magenta and pink
// );
// #endif
// #ifdef BENRI_ENABLE
// const rgblight_segment_t PROGMEM benri_layer[] = RGBLIGHT_LAYER_SEGMENTS(
//     {0, RGBLED_NUM/4, 234, 175, 255}, // between magenta and pink
//     {RGBLED_NUM/4, (RGBLED_NUM/4)*3, HSV_WHITE},
//     // {RGBLED_NUM/2, RGBLED_NUM, HSV_WHITE},
//     {(RGBLED_NUM/4)*3, RGBLED_NUM, 234, 175, 255} // between magenta and pink
// );
// #endif
...
// #ifdef FANGBIAN_ENABLE
//     rgblight_set_layer_state(2, layer_state_cmp(state, _FANGBIAN));
// #endif
// #ifdef BENRI_ENABLE
//     rgblight_set_layer_state(3, layer_state_cmp(state, _BENRI));
// #endif
