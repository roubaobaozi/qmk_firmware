...
// #ifdef FANGBIAN_ENABLE
// const uint16_t PROGMEM tgfb_combo[] = {KC_F, KC_B, KC_K, COMBO_END}; // toggle Fangbian keyboard layout
// const uint16_t PROGMEM tgfb2_combo[] = {LTN(F), KC_B, KC_K, COMBO_END}; // toggle Fangbian keyboard layout
// const uint16_t PROGMEM bspcfb_combo[] = {KC_W, KC_P, KC_Q, COMBO_END};
// const uint16_t PROGMEM grvfb_combo[] = {KC_C, KC_D, COMBO_END};
// const uint16_t PROGMEM tabfb_combo[] = {KC_R, KC_COMM, COMBO_END};
// const uint16_t PROGMEM escfb_combo[] = {KC_R, MS(SLSH), COMBO_END};
// #endif
// #ifdef BENRI_ENABLE
// const uint16_t PROGMEM tgbr_combo[] = {KC_B, KC_R, KC_K, COMBO_END}; // toggle Benri keyboard layout
// const uint16_t PROGMEM bspcbr_combo[] = {KC_D, KC_G, KC_R, COMBO_END};
// const uint16_t PROGMEM grvbr_combo[] = {KC_V, KC_COMM, COMBO_END};
// const uint16_t PROGMEM tabbr_combo[] = {KC_B, KC_J, COMBO_END};
// const uint16_t PROGMEM entbr_combo[] = {KC_J, KC_C, COMBO_END};
// const uint16_t PROGMEM escbr_combo[] = {KC_B, MS(Z), COMBO_END};
// #endif
...
// #ifdef FANGBIAN_ENABLE
//     [CHD_TGFB] = COMBO(tgfb_combo, TGFB),
//     [CHD_TGFB2] = COMBO(tgfb2_combo, TGFB),
//     [CHD_BSPCFB] = COMBO(bspcfb_combo, KC_BSPC),
//     [CHD_GRVFB] = COMBO(grvfb_combo, KC_GRV),
//     [CHD_TABFB] = COMBO(tabfb_combo, KC_TAB),
//     [CHD_ESCFB] = COMBO(escfb_combo, KC_ESC),
// #endif
// #ifdef BENRI_ENABLE
//     [CHD_TGBR] = COMBO(tgbr_combo, TGBR),
//     [CHD_BSPCBR] = COMBO(bspcbr_combo, KC_BSPC),
//     [CHD_GRVBR] = COMBO(grvbr_combo, KC_GRV),
//     [CHD_TABBR] = COMBO(tabbr_combo, KC_TAB),
//     [CHD_ENTBR] = COMBO(entbr_combo, KC_ENT),
//     [CHD_ESCBR] = COMBO(escbr_combo, KC_ESC),
// #endif
#if defined(UNICODEMAP_ENABLE) || defined(UNICODE_ENABLE)
