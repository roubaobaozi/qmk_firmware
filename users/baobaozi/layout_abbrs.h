...
#define _________________ROW_MID_KB_R____________________ KC_F11   ,KC_F12   ,ASG(Y)   ,ASC(SPC) ,AC(DOWN)
#define _________________ROW_BOT_KB_R____________________ FLASHIT  ,AG(F2)   ,KC_PAUS  ,KC_SCRL  ,AC(UP)
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
