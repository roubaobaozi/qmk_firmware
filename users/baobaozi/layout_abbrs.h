...
#define __T_R2___ MC(F21) // one shot shift on tap + ctrl on hold
...
// LEFT                                                  ┌─── Q ───┬─── W ───┬─── F ───┬─── P ───┬─── G ───┐
#define _________________ROW_TOP_NAV_L___________________ TGNAV    ,OS(LSFT) ,AG(R)    ,KC_VOLU  ,AC(C)
...
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── J ───┬─── L ───┬─── U ───┬─── Y ───┬─── ; ───┐
#define _________________ROW_TOP_NAV_R___________________ AG(R)    ,AA(LEFT) ,KC_PGUP  ,KC_PGDN  ,AA(RGHT)
...
// #define _________________ROW_TOP_SYM_R___________________ KC_BSLS  ,KC_RBRC  ,KC_RPRN  ,KC_QUOT  ,KC_SCLN do i want to change it back? nah, probably not
...
#define _________________ROW_MID_KB_R____________________ KC_F11   ,KC_F12   ,KC_PAUS  ,KC_SLCK  ,RESET
#define _________________ROW_BOT_KB_R____________________ RGB_M_SW ,ASG(Y)   ,ASG(SPC) ,AG(F2)   ,KC_F6
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// // EMO (emoji layer)
// // LEFT                                                  ┌─── Q ───┬─── W ───┬─── F ───┬─── P ───┬─── G ───┐
