...
#define _________________ROW_BOT_NUM_L___________________ KC_PENT  ,_______  ,OS(LSFT) ,KC_DOWN  ,MBUFF     // ALL(NO) where KC_PENT is, for mod masking numpad as functionkeypad
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── J ───┬─── L ───┬─── U ───┬─── Y ───┬─── ; ───┐
...
#define _________________ROW_BOT_SYN_L___________________ KC_LEFT  ,KC_UP    ,KC_DOWN  ,MG(RGHT) ,MBUFF
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── J ───┬─── L ───┬─── U ───┬─── Y ───┬─── ; ───┐
