...
// #define TGFB TG(_FANGBIAN)
// #define TGBR TG(_BENRI)
...
#define __T_L3___ KC_LCTL // MC(F22) = key repeater + crtl
// If there's an extra left thumb key:
#define __T_L4___ LTK(CAPS)
// Right thumbs
#define __T_R1___ MG(SPC)
#define __T_R2___ MA(F21) // one shot shift + alt
#define __T_R3___ LTK(CAPS)
// If there's an extra right thumb key, I prefer it between 2 and 3:
#define __T_R2B__ KC_LCTL

// Fangbian thumb keys
#define _TFB_L1__ MG(A)
#define _TFB_R1__ MG(I)
#define _TFB_R2__ MA(SPC)

// Benri thumb keys
#define _TBR_L1__ MG(I)
#define _TBR_L2__ MA(SPC)
#define _TBR_R1__ MG(N)
#define _TBR_R2__ MA(MINS)
...
// Fangbian Layout
// LEFT                                                  ┌─── F ───┬─── Y ───┬─── Z ───┬─── J ───┬─── K ───┐
#define _________________ROW_TOP_FANGB_L_________________ LTN(F)   ,LTS(Y)   ,KC_Z     ,KC_J     ,KC_K
#define _________________ROW_MID_FANGB_L_________________ KC_S     ,KC_H     ,KC_N     ,KC_G     ,KC_B
#define _________________ROW_BOT_FANGB_L_________________ MS(M)    ,LT0(X)   ,KC_C     ,KC_D     ,KC_L
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── ⬇️ ───┬─── W ───┬─── Q ───┬─── P ───┬─── ; ───┐
#define _________________ROW_TOP_FANGB_R_________________ KC_DOWN  ,KC_W     ,KC_Q     ,KC_P     ,KC_SCLN
#define _________________ROW_MID_FANGB_R_________________ KC_1     ,KC_T     ,KC_E     ,KC_U     ,KC_O
#define _________________ROW_BOT_FANGB_R_________________ KC_V     ,KC_R     ,KC_COMM  ,KC_DOT   ,MS(SLSH)
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// Benri Layout
// LEFT                                                  ┌─── . ───┬─── W ───┬─── H ───┬─── L ───┬─── Q ───┐
#define _________________ROW_TOP_BENRI_L_________________ LTN(DOT) ,LTS(W)   ,KC_H     ,KC_L     ,KC_Q
#define _________________ROW_MID_BENRI_L_________________ KC_O     ,KC_E     ,KC_U     ,KC_A     ,KC_UP
#define _________________ROW_BOT_BENRI_L_________________ MS(SLSH) ,LT0(Y)   ,KC_V     ,KC_COMM  ,KC_SCLN
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── P ───┬─── D ───┬─── G ───┬─── R ───┬─── F ───┐
#define _________________ROW_TOP_BENRI_R_________________ KC_P     ,KC_D     ,KC_G     ,KC_R     ,KC_F
#define _________________ROW_MID_BENRI_R_________________ KC_DOWN  ,KC_S     ,KC_K     ,KC_T     ,KC_M
#define _________________ROW_BOT_BENRI_R_________________ KC_X     ,KC_B     ,KC_J     ,KC_C     ,MS(Z)
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
...
// LEFT                                                  ┌─── Q ───┬─── W ───┬─── F ───┬─── P ───┬─── G ───┐
#define _________________ROW_TOP_SYM_L___________________ XXXXXXX  ,_______  ,OS(LSFT) ,TD(SQUO) ,TD(DQUO)
...
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── J ───┬─── L ───┬─── U ───┬─── Y ───┬─── ; ───┐
#define _________________ROW_TOP_SYM_R___________________ KC_BSLS  ,KC_RBRC  ,KC_RPRN  ,TD(ENEM) ,KC_SCLN
...
// LEFT                                                  ┌─── Q ───┬─── W ───┬─── F ───┬─── P ───┬─── G ───┐
#define _________________ROW_TOP_NUM_L___________________ XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,XXXXXXX  ,KC_RPRN
#define _________________ROW_MID_NUM_L___________________ XXXXXXX  ,XXXXXXX  ,KC_EQL   ,KC_SLSH  ,KC_LPRN
#define _________________ROW_BOT_NUM_L___________________ KC_PENT  ,_______  ,OS(LSFT) ,KC_LT    ,KC_GT     // ALL(NO) where KC_CURT is, for mod masking numpad as functionkeypad
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// RIGHT                                                 ┌─── J ───┬─── L ───┬─── U ───┬─── Y ───┬─── ; ───┐
...
#define _________________ROW_BOT_KB_R____________________ XXXXXXX  ,ASG(Y)   ,ASG(SPC) ,AG(F2)   ,KC_F6
//                                                       └─────────┴─────────┴─────────┴─────────┴─────────┘
// // EMO (emoji layer)
// // LEFT                                                  ┌─── Q ───┬─── W ───┬─── F ───┬─── P ───┬─── G ───┐
