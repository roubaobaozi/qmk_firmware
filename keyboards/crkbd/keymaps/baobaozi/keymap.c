...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //     // ┌─ Extra ─┬─── Q ───┬─── W ───┬─── F ───┬─── P ───┬─── G ───┐                   ┌─── J ───┬─── L ───┬─── U ───┬─── Y ───┬─── ; ───┬─ Extra ─┐
    //         _______  ,_________________ROW_TOP_FANGB_L_________________,                    _________________ROW_TOP_FANGB_R_________________,_______  ,
    //     // ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤                   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
    //         _______  ,_________________ROW_MID_FANGB_L_________________,                    _________________ROW_MID_FANGB_R_________________,_______  ,
    //     // ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤                   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
    //         _______  ,_________________ROW_BOT_FANGB_L_________________,                    _________________ROW_BOT_FANGB_R_________________,_______  ,
    //     // └─────────┴─────────┴─────────┴─────┬───┴─────┬───┴─────┬───┴─────┐       ┌─────┴───┬─────┴───┬─────┴───┬─────┴─────────┴─────────┴─────────┘
    //                                             _______  ,_______  ,_______  ,        _______  ,_______  ,_______
    //                                         // └─────────┴─────────┴─────────┘       └─────────┴─────────┴─────────┘
    // ),
...
//     } else if(layer_state_is(_FANGBIAN)) {
//         oled_write_P(PSTR(" FBK\n"), false);
//         oled_write_P(PSTR(" zh\n"), false);
// #endif
// #ifdef BENRI_ENABLE
//     } else if(layer_state_is(_BENRI)) {
//         oled_write_P(PSTR(" BRK\n"), false);
//         oled_write_P(PSTR(" ja\n"), false);
// #endif
